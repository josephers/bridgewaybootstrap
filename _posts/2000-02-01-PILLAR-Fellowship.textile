...
<div id="membershipModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="membership" aria-hidden="true">
  <form action="https://docs.google.com/forms/d/1L3TKbloZqKaseS6_XSjg1iVJBAtJaUtswVv8DgR9x0c/formResponse" method="POST" id="ss-form" target="_self" onsubmit="" style="margin-bottom:0">

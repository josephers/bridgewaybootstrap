...
<div id="membershipModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="membership" aria-hidden="true">
  <form action="https://docs.google.com/forms/d/1L3TKbloZqKaseS6_XSjg1iVJBAtJaUtswVv8DgR9x0c/formResponse" id="ss-form" onsubmit="$.post('https://docs.google.com/forms/d/1L3TKbloZqKaseS6_XSjg1iVJBAtJaUtswVv8DgR9x0c/formResponse', $('#ss-form').serialize());$('#membershipModal').modal('hide')" class="form-horizontal">
  ...
  <div class="modal-footer">
    ...
    <input class="btn btn-success" type="submit" name="submit" value="Submit" id="ss-submit">
  </div>
  </form>
</div>